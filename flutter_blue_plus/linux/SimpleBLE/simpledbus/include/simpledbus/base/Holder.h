...
class Holder {
  public:
    ...
    std::experimental::fundamentals_v1::any get_contents() const;
    ...
    void dict_append(Type key_type, std::experimental::fundamentals_v1::any key, Holder value);
  ...
  private:
    ...
    std::vector<std::tuple<Type, std::experimental::fundamentals_v1::any, Holder>> holder_dict;
    ...
    static std::string _represent_type(Type type, std::experimental::fundamentals_v1::any value);
};
